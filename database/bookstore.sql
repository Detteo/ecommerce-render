...
-- SUSPENSO (3)
('it', 'Stephen King', 'Suspenso', 'En la ciudad de Derry, un grupo de niños enfrenta un terror que regresa cada 27 años con la forma de un payaso demoníaco llamado Pennywise.', 65000, 'payaso.jpg'),
